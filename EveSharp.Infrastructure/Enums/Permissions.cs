...
namespace EveSharp.Infrastructure.Enums
{
	public class Permissions : SmartEnum<Permissions, string>
	{
		...
		public static readonly Permissions READ_CORPORATION_BOOKMARKS = new("Read Character Bookmarks", "esi-bookmarks.read_corporation_bookmarks.v1");
		...
		public static readonly Permissions READ_CHARACTER_AGENTS = new("Read Agents Research", "esi-character.read_agents_research.v1");
		public static readonly Permissions READ_CHARACTER_BLUEPRINTS = new("Read Character Blueprints", "esi-character.read_blueprints.v1");
		public static readonly Permissions READ_CHARACTER_CONTACTS = new("Read Character Contacts", "esi-character.read_contacts.v1");
		public static readonly Permissions READ_CHARACTER_CORPORATION_ROLES = new("Read Corporation Roles", "esi-character.read_corporation_roles.v1");
		public static readonly Permissions READ_CHARACTER_FATIGUE = new("Read Character Jump Fatigue", "esi-character.read_fatigue.v1");
		public static readonly Permissions READ_CHARACTER_FW_STATS = new("Read Character Faction Warfare Stats", "esi-character.read_fw_stats.v1");
		public static readonly Permissions READ_LOYALTY_POINTS = new("Read Character Loyalty Points", "esi-character.read_loyalty.v1");
		public static readonly Permissions READ_CHARACTER_MEDALS = new("Read Character Medals", "esi-character.read_medals.v1");
		public static readonly Permissions READ_CHARACTER_NOTIFICATIONS = new("Read Character Notifications", "esi-character.read_notifications.v1");
		public static readonly Permissions READ_CHARACTER_OPPORTUNITIES = new("Read Character Opportunities", "esi-character.read_opportunities.v1");
		public static readonly Permissions READ_CHARACTER_STANDINGS = new("Read Character Opportunities", "esi-character.read_standings.v1");
		public static readonly Permissions READ_CHARACTER_TITLES = new("Read Character Titles", "esi-character.read_titles.v1");
		public static readonly Permissions WRITE_CHARACTER_CONTACTS = new("Write Character Contacts", "esi-character.write_contacts.v1");
		public static readonly Permissions READ_CHARACTER_CLONES = new("Read Character Clones", "esi-character.read_clones.v1");
		public static readonly Permissions READ_CHARACTER_IMPLANTS = new("Read Character Implants", "esi-character.read_implants.v1");
		...
		public static readonly Permissions READ_LOCATION = new("Read Location", "esi-location.read_locoation.v1");
		public static readonly Permissions READ_ONLINE = new("Read Location", "esi-location.read_online.v1");
		public static readonly Permissions READ_SHIP_TYPE = new("Read Location", "esi-location.read_ship_type.v1");
		...
		public static readonly Permissions READ_CHARACTER_ORDERS = new("Read Character Orders", "esi-market.character_orders.v1");
		public static readonly Permissions READ_CORPORATION_ORDERS = new("Read Corporation Orders", "esi-market.corporation_orders.v1");
		public static readonly Permissions READ_STRUCTURE_MARKETS = new("Read Structure Markets", "esi-market.structure_markets.v1");
